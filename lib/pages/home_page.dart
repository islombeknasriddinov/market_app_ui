        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              makeItem("assets/images/images4.jpg"),
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              Text("Mustle Car", style: TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.bold),),
                              SizedBox(width: 10,),
                              Text("Electric", style: TextStyle(color: Colors.red, fontSize: 15),),
                            ],
                          ),
  ...
  Widget singleTab(bool type, String text) {
      return AspectRatio(
        ...
        child: Container(
          ...
          child: Center(
            child: Text(text,style: TextStyle(fontSize: type? 18:15),),
          ),
        ),
      );
  }
